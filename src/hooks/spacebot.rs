...
mod tests {
    ...
    async fn outcome_signal_allows_text_only_completion_when_not_terminal() {
        ...
        let _ = <SpacebotHook as PromptHook<SpacebotModel>>::on_tool_call(
            ...
            None,
            "internal_2",
            "{\"status\":\"Email sent successfully\",\"kind\":\"outcome\",\"evidence\":[{\"command\":\"echo hello\",\"exit_code\":0}]}",
        )
        .await;
        let _ = <SpacebotHook as PromptHook<SpacebotModel>>::on_tool_result(
            ...
            "internal_2",
            "{\"status\":\"Email sent successfully\",\"kind\":\"outcome\",\"evidence\":[{\"command\":\"echo hello\",\"exit_code\":0}]}",
            "{\"success\":true,\"worker_id\":1,\"status\":\"Email sent successfully\",\"kind\":\"outcome\",\"evidence\":[{\"command\":\"echo hello\",\"exit_code\":0}]}",
        )
        .await;
